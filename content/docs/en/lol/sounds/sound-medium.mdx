...
### Splitting into audio and events in custom banks

When generating SoundBanks, Wwise can bundle structure and media into a single bank. Optionally you can decide to split audio from events/structure. (Splitting allows other to later edit your custom banks by using [Quartz](https://wiki.divineskins.gg/en/docs/lol/sounds/sound-easy))

If u decide to split:
...
2. Right-click icon on right of **Pitch**.
3. Set a range, eg. from `-100` to `+100`.
